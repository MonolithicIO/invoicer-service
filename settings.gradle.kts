...
include(":domains:intermediary:data:api")
include(":domains:intermediary:data:test")
include(":domains:intermediary:domain:api")
include(":domains:intermediary:domain:test")