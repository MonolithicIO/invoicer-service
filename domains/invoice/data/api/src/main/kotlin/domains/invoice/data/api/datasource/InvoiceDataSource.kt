package domains.invoice.data.api.datasource

import domains.invoice.domain.api.model.CreateInvoiceModel
import domains.invoice.domain.api.model.GetInvoicesFilterModel
...
internal class InvoiceDataSourceImpl(
    ...
    override fun createInvoice(
        ...
        val newInvoice = InvoiceTable.insertAndGetId {
            ...
            it[intermediary] = data.intermediaryId?.let { intermediaryId ->
                UUID.fromString(
                    intermediaryId
                )
            }
